...
{
    /// <summary>
    /// A state that can be runned in the <see cref="AI.StateMachine"/>. Can be added to and edited inside <see cref="StateData"/>. <br/>
    ...
    public abstract class State : ScriptableObject
    {
        ...
        /// <summary>
        /// Attempts to get the reference of the specified component type from <see cref="AI.StateMachine"/>. 
        ...
        /// <returns>The component reference stored in <see cref="AI.StateMachine"/> if it exists, otherwise null</returns>
