...
namespace LobsterFramework
{
    ...
    public class CharacterStateManager : MonoBehaviour
    {
        ...
        private CombinedValueEffector<bool> postureAbilityLock;
        ...
        void Start()
        {
            ...
            postureAbilityLock = abilityManager.ActionBlocked.MakeEffector();
            suppressAbilityLock = abilityManager.ActionBlocked.MakeEffector(); 
            poiseAbilityLock = abilityManager.ActionBlocked.MakeEffector();
        ...
        private void OnPostureStatusChanged(bool postureBroken)
        {
            ...
            if (postureBroken)
            {
                ...
                postureAbilityLock.Apply(true);
            }
            else
            {
                postureMoveLock.Release();
                postureAbilityLock.Release();
            }
            ComputeStateAndPlayAnimation();
        }
