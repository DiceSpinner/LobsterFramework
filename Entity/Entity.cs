...
namespace LobsterFramework
{
    ...
    public class Entity : MonoBehaviour
    {
        ...
        public bool RegenSuppressed { get { return (Time.time - damagedSince) < Setting.Instance.SUPPRESS_REGEN_DURATION; } }
        ...
        private CombinedValueEffector<float> pbHealthDamageModifierAccessor;
        ...
        private CombinedValueEffector<float> baseHealthRegenAccessor;
        private CombinedValueEffector<float> basePostureRegenAccessor;
        ...
        { 
            ...
            baseHealthRegenAccessor = regenBuffer.healthRegen.MakeEffector();
            baseHealthRegenAccessor.Apply(baseHealthRegen.Value);

            basePostureRegenAccessor = regenBuffer.postureRegen.MakeEffector();
            basePostureRegenAccessor.Apply(basePostureRegen.Value);

            pbHealthDamageModifierAccessor = damageBuffer.healthDamageModifier.MakeEffector();
        }
        ...
        private void Update()
        {
            ...
            if (PostureBroken) {
                ...
                if (pbCounter >= Setting.Instance.POSTURE_BROKEN_DURATION) { 
                    PostureRecover();
                }
            }
        ...
        private void PostureBreak() {
            pbHealthDamageModifierAccessor.Apply(Setting.Instance.POSTURE_BROKEN_DAMAGE_MODIFIER);
            pbCounter = 0;
            PostureBroken = true;
        ...
        private class DamageTracker
        {
            ...
            public bool CountDown()
            {
                ...
                return counter >= Setting.Instance.EXPIRE_ATTACK_TIME;
            }
        }
    }
